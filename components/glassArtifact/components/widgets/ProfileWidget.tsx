...
export const ProfileWidget: React.FC<{ isExpanded?: boolean }> = ({ isExpanded }) => {
    ...
    return (
      <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center md:items-start text-white">
        <div className="w-36 h-36 md:w-48 md:h-48 rounded-[28px] md:rounded-[40px] overflow-hidden border-2 border-white/30 shadow-2xl shrink-0">
          <img src="https://picsum.photos/400/400?random=1" className="w-full h-full object-cover" alt="Profile" />
        </div>
        <div className="flex-1 space-y-4 md:space-y-6 text-center md:text-left">
          <div>
            <h1 className="text-2xl md:text-4xl font-bold mb-2">Alex Sterling</h1>
          ...
          <p className="text-white/80 text-sm md:text-base leading-relaxed max-w-xl">
            Passionate about creating spatial computing experiences that blend the physical and digital worlds. 
            Currently focused on "Frosted Aerogel" aesthetic explorations and elastic grid systems.
          </p>
  ...
  return (
    ...
    >
      ...
      >
        <img src="https://picsum.photos/400/400?random=1" className="w-full h-full object-cover" alt="Avatar" />
      </motion.div>
      <div className="w-full md:w-1/2 flex flex-col justify-center">
        <h3 className="text-xl font-bold text-white mb-1">Alex Sterling</h3>
        <p className="text-xs text-white/50 mb-4 uppercase tracking-wider">Spatial Architect</p>
