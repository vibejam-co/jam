...
const KineticSlice: React.FC<KineticSliceProps> = ({ data, isExpanded, onHover, onLeave }) => {
  return (
    <motion.div
      layout
    ...
    >
      ...
      `}>
        <div className="flex flex-col md:flex-row items-center justify-center">
            <span className="font-oswald text-xs tracking-[1em] opacity-50 mb-4 md:mb-0 md:mr-8 [writing-mode:vertical-rl] rotate-180">
                {data.id}
            </span>
            <h3 className="font-oswald text-4xl md:text-7xl font-bold tracking-tighter text-white whitespace-nowrap uppercase [writing-mode:horizontal-tb] md:[writing-mode:vertical-rl] md:rotate-180">
                {data.title}
            </h3>
        </div>
      </div>
